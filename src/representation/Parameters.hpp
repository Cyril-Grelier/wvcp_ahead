...
struct Parameters {
    ...
    /** @brief Adaptive crossover (memetic)*/
    const int population_size;
    /** @brief Number of selected individuals (memetic)*/
    const int nb_selected;
    /** @brief Possible crossover (memetic)*/
    const std::vector<std::string> crossover;
    /** @brief Possible balances for the crossover (memetic)*/
    const std::vector<std::string> colors_p1s;
    /** @brief Local search (any method)*/
    const std::vector<std::string> local_search;
    /** @brief Adaptive (memetic)*/
    const std::string adaptive;
    /** @brief Size of the sliding window for the adaptive criteria (memetic)*/
    const int window_size;

    const double coeff_exploi_explo;
    const bool return_last_legal;
    ...
    explicit Parameters(const std::string &problem_,
                        ...
                        const int nb_selected_,
                        const std::string &crossover_,
                        const std::string &colors_p1s_,
                        const std::string &local_search_,
                        const std::string &adaptive_,
                        const int window_size_,
                        const double coeff_exploi_explo_,
                        const bool return_last_legal_,
