...
class Solution {
  public:
    ...
    /** @brief Number of solutions created*/
    static int nb_total_solution;

    /** @brief Age of the solution for the memetic algorithm*/
    int age{0};
    /** @brief id of the solution for the memetic algorithm*/
    int id{0};

    /** @brief Solutions crossed with the current solution*/
    std::set<int> past_marriages;
