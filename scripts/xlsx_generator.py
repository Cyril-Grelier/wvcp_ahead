...
def main():
    ...
    methods: list[tuple(str, str)] = [
        # 1h with 2 CPU, 2h with 1 CPU
        ("MCTS+UCB", "outputs/wvcp_hard_mcts_ucb_2h/ucb"),
        ("RedLS", "outputs/wvcp_hard_ls_2h/redls"),
        ("ILS-TS", "outputs/wvcp_hard_ls_2h/ilsts"),
        ("HEAD+RedLS", "outputs/wvcp_hard_head_1h/redls"),
        ("HEAD+ILS-TS", "outputs/wvcp_hard_head_1h/ilsts"),
        ("AHEAD+Random", "outputs/wvcp_hard_ahead_1h/random"),
        ("AHEAD+Roulette", "outputs/wvcp_hard_ahead_1h/roulette_wheel"),
        ("AHEAD+Deleter", "outputs/wvcp_hard_ahead_1h/deleter"),
        ("AHEAD+UCB", "outputs/wvcp_hard_ahead_1h/ucb"),
        ("AHEAD+Pursuit", "outputs/wvcp_hard_ahead_1h/pursuit"),
        ("AHEAD+NN", "outputs/wvcp_hard_ahead_1h/neural_net_cross"),
        #
        # 4h with 2 CPU, 8h with 1 CPU
        # ("MCTS+UCB", "outputs/wvcp_hard_mcts_ucb_8h/ucb"),
        # ("RedLS", "outputs/wvcp_hard_ls_8h/redls"),
        # ("ILS-TS", "outputs/wvcp_hard_ls_8h/ilsts"),
        # ("HEAD+RedLS", "outputs/wvcp_hard_head_4h/redls"),
        # ("HEAD+ILS-TS", "outputs/wvcp_hard_head_4h/ilsts"),
        # ("AHEAD+Random", "outputs/wvcp_hard_ahead_4h/random"),
        # ("AHEAD+Roulette", "outputs/wvcp_hard_ahead_4h/roulette_wheel"),
        # ("AHEAD+Deleter", "outputs/wvcp_hard_ahead_4h/deleter"),
        # ("AHEAD+UCB", "outputs/wvcp_hard_ahead_4h/ucb"),
        # ("AHEAD+Pursuit", "outputs/wvcp_hard_ahead_4h/pursuit"),
        # ("AHEAD+NN", "outputs/wvcp_hard_ahead_4h/neural_net_cross"),
    ]

    problem = "wvcp"

    # Choose the set of instances
    instances_set = ("../DIMACS_hard", "hard")

    output_file = "xlsx_files/wvcp_hard_all_methods_4h_8h.xlsx"
    output_file = "xlsx_files/wvcp_hard_all_methods_1h_2h.xlsx"
